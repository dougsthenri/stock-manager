...
/** Generate an @c NSISO8601DateFormatter  conforming to the ISO 8601 standard.
...
@code
myDB.dateFormat = [FMDatabase storeableDateFormatISO8601];
@endcode
 
 @return A @c NSISO8601DateFormatter  that can be used for converting dates to strings and vice versa.
 
 @see hasDateFormatter
 @see setDateFormat:
 @see dateFromString:
 @see stringFromDate:
 @see storeableDateFormatISO8601

 @warning Note that @c NSISO8601DateFormatter  is not thread-safe, so the formatter generated by this method should be assigned to only one FMDB instance and should not be used for other purposes.
...
/** Set to a date formatter to use string dates with sqlite instead of the default UNIX timestamps.
 ...
 @param format Set to nil to use UNIX timestamps. Defaults to nil. Should be set using a formatter generated using @c FMDatabase:storeableDateFormatISO8601 .
 ...
 @warning Note there is no direct getter for the @c NSISO8601DateFormatter , and you should not use the formatter you pass to FMDB for other purposes, as @c NSISO8601DateFormatter  is not thread-safe.
 */

- (void)setDateFormat:(NSISO8601DateFormatter * _Nullable)format;
